...
export class User extends Entity {
  ...
  set lastMint(value: BigInt) {
    this.set("lastMint", Value.fromBigInt(value));
  }

  get lastBurn(): BigInt {
    let value = this.get("lastBurn");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set lastBurn(value: BigInt) {
    this.set("lastBurn", Value.fromBigInt(value));
  }

  get twLiqUSD(): BigDecimal {
    let value = this.get("twLiqUSD");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set twLiqUSD(value: BigDecimal) {
    this.set("twLiqUSD", Value.fromBigDecimal(value));
  }
}
